...
var modifier = typeof window !== "undefined" && window.navigator.platform.toLowerCase().indexOf("mac") === 0 ? import_react2.default.createElement("code", { className: "graphiql-key" }, "Cmd") : import_react2.default.createElement("code", { className: "graphiql-key" }, "Ctrl");
function GraphiQLInterface(props) {
  ...
  var onClickReference = (0, import_react2.useCallback)(function() {
    if (pluginResize.hiddenElement === "first") {
      pluginResize.setHiddenElement(null);
    }
  }, [pluginResize]);
  var handleClearData = (0, import_react2.useCallback)(function() {
    try {
  ...
  var handlePersistHeaders = (0, import_react2.useCallback)(function(event) {
    editorContext.setShouldPersistHeaders(event.currentTarget.dataset.value === "true");
  }, [editorContext]);
  var handleChangeTheme = (0, import_react2.useCallback)(function(event) {
  ...
  var handleShowDialog = (0, import_react2.useCallback)(function(event) {
    setShowDialog(event.currentTarget.dataset.value);
  }, []);
  var handlePluginClick = (0, import_react2.useCallback)(function(e) {
  ...
  var handleVariablesTabClick = (0, import_react2.useCallback)(function() {
    if (editorToolsResize.hiddenElement === "second") {
      editorToolsResize.setHiddenElement(null);
    }
    setActiveSecondaryEditor("variables");
  }, [editorToolsResize]);
  var handleHeadersTabClick = (0, import_react2.useCallback)(function() {
    if (editorToolsResize.hiddenElement === "second") {
      editorToolsResize.setHiddenElement(null);
    }
    setActiveSecondaryEditor("headers");
  }, [editorToolsResize]);
  var toggleEditorTools = (0, import_react2.useCallback)(function() {
    editorToolsResize.setHiddenElement(editorToolsResize.hiddenElement === "second" ? null : "second");
  }, [editorToolsResize]);
  var handleDismissShortKeysDialog = (0, import_react2.useCallback)(function() {
    setShowDialog(null);
  }, []);
  var handleDismissSettingsDialog = (0, import_react2.useCallback)(function() {
    setShowDialog(null);
  ...
  return import_react2.default.createElement(
    ...
    import_react2.default.createElement(
      ...
      import_react2.default.createElement("div", { className: "graphiql-sidebar-section" }, pluginContext === null || pluginContext === void 0 ? void 0 : pluginContext.plugins.map(function(plugin, index) {
                ...
                import_react2.default.createElement(
                  ...
                  import_react2.default.createElement(
                    ...
                    import_react2.default.createElement(
                      ...
                      import_react2.default.createElement(UnStyledButton, { type: "button", className: activeSecondaryEditor === "variables" && editorToolsResize.hiddenElement !== "second" ? "active" : "", onClick: handleVariablesTabClick }, "Variables"),
                      isHeadersEditorEnabled ? import_react2.default.createElement(UnStyledButton, { type: "button", className: activeSecondaryEditor === "headers" && editorToolsResize.hiddenElement !== "second" ? "active" : "", onClick: handleHeadersTabClick }, "Headers") : null
                    ),
                    import_react2.default.createElement(
                      Tooltip,
                      { label: editorToolsResize.hiddenElement === "second" ? "Show editor tools" : "Hide editor tools" },
                      import_react2.default.createElement(UnStyledButton, { type: "button", onClick: toggleEditorTools, "aria-label": editorToolsResize.hiddenElement === "second" ? "Show editor tools" : "Hide editor tools" }, editorToolsResize.hiddenElement === "second" ? import_react2.default.createElement(ChevronUpIcon, { className: "graphiql-chevron-icon", "aria-hidden": "true" }) : import_react2.default.createElement(ChevronDownIcon, { className: "graphiql-chevron-icon", "aria-hidden": "true" }))
                    )
                  )
                ),
                import_react2.default.createElement(
    ...
    import_react2.default.createElement(
      Dialog2,
      { isOpen: showDialog === "short-keys", onDismiss: handleDismissShortKeysDialog },
      import_react2.default.createElement(
        "div",
        { className: "graphiql-dialog-header" },
        import_react2.default.createElement("div", { className: "graphiql-dialog-title" }, "Short Keys"),
        import_react2.default.createElement(Dialog2.Close, { onClick: handleDismissShortKeysDialog })
      ),
      import_react2.default.createElement(
        "div",
    ...
    import_react2.default.createElement(
      Dialog2,
      { isOpen: showDialog === "settings", onDismiss: handleDismissSettingsDialog },
      import_react2.default.createElement(
        "div",
        { className: "graphiql-dialog-header" },
        import_react2.default.createElement("div", { className: "graphiql-dialog-title" }, "Settings"),
        import_react2.default.createElement(Dialog2.Close, { onClick: handleDismissSettingsDialog })
      ),
      props.showPersistHeadersSettings ? import_react2.default.createElement(
        ...
        import_react2.default.createElement(
          ButtonGroup,
          null,
          import_react2.default.createElement(Button, { type: "button", id: "enable-persist-headers", className: editorContext.shouldPersistHeaders ? "active" : "", "data-value": "true", onClick: handlePersistHeaders }, "On"),
          import_react2.default.createElement(Button, { type: "button", id: "disable-persist-headers", className: editorContext.shouldPersistHeaders ? "" : "active", onClick: handlePersistHeaders }, "Off")
        )
      ) : null,
      import_react2.default.createElement(
        "div",
        ...
        import_react2.default.createElement(
          ...
          import_react2.default.createElement(
            ButtonGroup,
            null,
            import_react2.default.createElement(Button, { type: "button", className: theme === null ? "active" : "", onClick: handleChangeTheme }, "System"),
            import_react2.default.createElement(Button, { type: "button", className: theme === "light" ? "active" : "", "data-theme": "light", onClick: handleChangeTheme }, "Light"),
            import_react2.default.createElement(Button, { type: "button", className: theme === "dark" ? "active" : "", "data-theme": "dark", onClick: handleChangeTheme }, "Dark")
          )
        )
      ),
      storageContext ? import_react2.default.createElement(
        ...
        import_react2.default.createElement(
          "div",
          null,
          import_react2.default.createElement(Button, { type: "button", state: clearStorageStatus || void 0, disabled: clearStorageStatus === "success", onClick: handleClearData }, clearStorageStatus === "success" ? "Cleared data" : clearStorageStatus === "error" ? "Failed" : "Clear data")
        )
      ) : null
    )
  );
