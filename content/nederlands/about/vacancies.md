...
quick_navigation:
 title: Overzicht
 links:
   - title: Lead generatieve AI 
     url: '#gen-AI'
dynamic_form_engine:
  - title: Sollicitatieformulier Lead generatieve AI
    id: form1
...
{{< accordion_item_open title="Lead generatieve AI (1.0 fte)" image="/images/logo/logo.svg" id="" background_color="#ffffff" tag1="deadline 20-04-2026" >}}
