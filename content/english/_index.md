  ...
  - title: Core activities
    ...
    items:
      - title: Knowledge platform
        description: Statistical and legal expertise
        icon: fa fa-layer-group
        link: /knowledge-platform/knowledge-base/
      - title: Algoprudence
        description: Case-based normative advice
        icon: fas fa-balance-scale
        link: /algoprudence/
      - title: Technical tools
        description: Open source AI auditing tools
        icon: fas fa-toolbox
        link: /technical-tools/
      - title: Project work
        description: 'Algorithm validation, AI Act implementation'
