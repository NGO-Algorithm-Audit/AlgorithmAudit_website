...
{{< accordion_item_open title="Projectmedewerker (Dutch only)" image="/images/logo/logo.svg" background_color="#ffffff" id="projectmedewerker" tag1="1.0 fte" tag2="Salary level 7-8" tag3="≥01-05-2025" >}}
...
{{< accordion_item_open title="Internship" image="/images/logo/logo.svg" background_color="#ffffff" id="projectmedewerker" tag1="0.6-1.0 fte" tag2="Salary level 5" tag3="≥01-05-2025" >}}
{{< button button_text="Solliciteer" button_link="#form" >}}
...
#### Wat verwachten wij?
-	Je komt minimaal 1 à 2 dagen in de week naar ons kantoor in Den Haag;
-	Bereidheid om binnenlands te reizen, en incidenteel Europees;
-	Nederlandse nationaliteit of werkvergunning.
