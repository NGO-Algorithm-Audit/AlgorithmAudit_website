...
quick_navigation:
 ...
 links:
   - title: Lead Generative AI Evaluation
     url: '#gen-AI'
dynamic_form_engine:
  - title: Submission form Lead Generative AI Evaluation
    id: form1
...
{{< accordion_item_open title="Lead generatieve AI evaluation (1.0 fte) (Dutch speaking only)" image="/images/logo/logo.svg" id="" background_color="#ffffff" tag1="deadline 30-04-2026" >}}
